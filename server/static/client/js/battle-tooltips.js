...
_side=this.battle.sides[_sideIndex];
}else{
_side=this.battle.sides[+this.battle.viewpointSwitched^_sideIndex];
...
var zEffect='';
var foeActive=[];
if(this.battle.gameType==='freeforall'){for(var _i8=0,_this$battle$sides4=

this.battle.sides;_i8<_this$battle$sides4.length;_i8++){var _foeActive;var side=_this$battle$sides4[_i8];
if(side===pokemon.side)continue;
(_foeActive=foeActive).push.apply(_foeActive,side.active);
}
}else{
foeActive=[].concat(pokemon.side.foe.active).reverse();
}
...
var basePowers=[];for(var _i10=0,_foeActive3=
foeActive;_i10<_foeActive3.length;_i10++){var active=_foeActive3[_i10];
if(!active)continue;
...
var numFoes=this.battle.sides.length-1;
...
}for(var _i12=0,_foeActive5=

foeActive;_i12<_foeActive5.length;_i12++){var possibleTarget=_foeActive5[_i12];
...
text+="<p class=\"tooltip-section\">";
var battlePokemon=clientPokemon||this.battle.findCorrespondingPokemon(pokemon);for(var _i14=0,_serverPokemon$moves2=
serverPokemon.moves;_i14<_serverPokemon$moves2.length;_i14++){var moveid=_serverPokemon$moves2[_i14];
var move=this.battle.dex.moves.get(moveid);
var moveName="&#8226; "+move.name;
if(battlePokemon!=null&&battlePokemon.moveTrack){for(var _i16=0,_battlePokemon$moveTr2=
battlePokemon.moveTrack;_i16<_battlePokemon$moveTr2.length;_i16++){var row=_battlePokemon$moveTr2[_i16];
if(moveName===row[0]){
...
text+="<p class=\"tooltip-section\">";for(var _i18=0,_clientPokemon$moveTr2=
clientPokemon.moveTrack;_i18<_clientPokemon$moveTr2.length;_i18++){var _ref2=_clientPokemon$moveTr2[_i18];var _moveName=_ref2[0];{
...
text+="<p class=\"tooltip-section\">";for(var _i20=0,_clientPokemon$moveTr4=
clientPokemon.moveTrack;_i20<_clientPokemon$moveTr4.length;_i20++){var _row=_clientPokemon$moveTr4[_i20];
...
var atLeastOne=false;for(var _i22=0,_this$battle$sides6=
this.battle.sides;_i22<_this$battle$sides6.length;_i22++){var side=_this$battle$sides6[_i22];
...
if(side.battle.speciesClause)return false;for(var _i24=0,_side$pokemon4=
side.pokemon;_i24<_side$pokemon4.length;_i24++){var ally=_side$pokemon4[_i24];
...
var pokemon=clientPokemon||serverPokemon;
var isPowerTrick=clientPokemon==null?void 0:clientPokemon.volatiles['powertrick'];for(var _i26=0,_Dex$statNamesExceptH2=
Dex.statNamesExceptHP;_i26<_Dex$statNamesExceptH2.length;_i26++){var statName=_Dex$statNamesExceptH2[_i26];
...
if(this.battle.gen<=1){for(var _i28=0,_Dex$statNamesExceptH4=
Dex.statNamesExceptHP;_i28<_Dex$statNamesExceptH4.length;_i28++){var _statName=_Dex$statNamesExceptH4[_i28];
...
if(allyActive){for(var _i30=0;_i30<
allyActive.length;_i30++){var ally=allyActive[_i30];
...
speedModifiers.push(2);
}for(var _i32=0,_Dex$statNamesExceptH6=
Dex.statNamesExceptHP;_i32<_Dex$statNamesExceptH6.length;_i32++){var _statName2=_Dex$statNamesExceptH6[_i32];
...
var abilityName=ability==='plus'?'Plus':'Minus';for(var _i34=0;_i34<
_allyActive.length;_i34++){var _ally=_allyActive[_i34];
...
var pokemon=value.pokemon;
var foeActive=[];
if(this.battle.gameType==='freeforall'){for(var _i48=0,_this$battle$sides8=
this.battle.sides;_i48<_this$battle$sides8.length;_i48++){var _foeActive6;var side=_this$battle$sides8[_i48];
if(side===pokemon.side)continue;
(_foeActive6=foeActive).push.apply(_foeActive6,side.active);
}
}else{
foeActive=[].concat(pokemon.side.foe.active).reverse();
}
...
if(this.battle.hardcoreMode){
var _tags='';for(var _i50=0,_foeActive8=
foeActive;_i50<_foeActive8.length;_i50++){var possibleTarget=_foeActive8[_i50];
if(!possibleTarget)continue;
var effectiveness=this.getMoveEffectiveness(pokemon,move,moveType,category,possibleTarget);
...
var tags="\xD7";for(var _i52=0,_foeActive10=
foeActive;_i52<_foeActive10.length;_i52++){var _possibleTarget=_foeActive10[_i52];
...
}for(var _i54=0,_pokemon$side$active2=

pokemon.side.active;_i54<_pokemon$side$active2.length;_i54++){var active=_pokemon$side$active2[_i54];
...
var chain=4096;for(var _i56=0;_i56<
accuracyModifiers.length;_i56++){var mod=accuracyModifiers[_i56];
if(mod!==4096){
...
var boostCount=0;for(var _i58=0,_Object$values2=
Object.values(target.boosts);_i58<_Object$values2.length;_i58++){var boost=_Object$values2[_i58];
...
var _boostCount=0;for(var _i60=0,_Object$values4=
Object.values(pokemon.boosts);_i60<_Object$values4.length;_i60++){var _boost=_Object$values4[_i60];
...
if(move.category!=='Status'){
var auraBoosted='';
var auraBroken=false;for(var _i62=0,_pokemon$side$active4=
pokemon.side.active;_i62<_pokemon$side$active4.length;_i62++){var ally=_pokemon$side$active4[_i62];
if(!ally||ally.fainted)continue;
var allyAbility=this.getAllyAbility(ally);
...
var foeSides=this.battle.gameType==='freeforall'?
this.battle.sides.filter(function(s){return s!==pokemon.side;}):
[pokemon.side.foe];for(var _i64=0;_i64<
foeSides.length;_i64++){var foeSide=foeSides[_i64];for(var _i66=0,_foeSide$active2=
foeSide.active;_i66<_foeSide$active2.length;_i66++){var foe=_foeSide$active2[_i66];
...
var _boostCount2=0;for(var _i68=0,_Object$values6=
Object.values(pokemon.boosts);_i68<_Object$values6.length;_i68++){var _boost2=_Object$values6[_i68];
...
for(var _i69=1;_i69<=5&&_i69<=pokemon.side.faintCounter;_i69++){
if(pokemon.volatiles["fallen"+_i69]){
value.abilityModify([1,1.15,1.3,1.45,1.6,1.75][_i69],"Hardcore Hustle");
}
}
...
for(var _i70=1;_i70<=5&&_i70<=pokemon.side.faintCounter;_i70++){
if(pokemon.volatiles["fallen"+_i70]){
value.abilityModify(1+0.05*_i70,"The Eminence in the Shadow");
}
}
}
...
if(fusionSpecies.exists&&fusionSpecies.name!==species.name){for(var _i74=0,_Object$values8=
Object.values(fusionSpecies.abilities);_i74<_Object$values8.length;_i74++){var newAbility=_Object$values8[_i74];
...
var origLeftoverEVs=508;for(var _i76=0,_Dex$statNames2=
Dex.statNames;_i76<_Dex$statNames2.length;_i76++){var _origSpread$evs;var stat=_Dex$statNames2[_i76];
...
if(!minusTooLow){for(var _i78=0,_Dex$statNamesExceptH14=
Dex.statNamesExceptHP;_i78<_Dex$statNamesExceptH14.length;_i78++){var _stat=_Dex$statNamesExceptH14[_i78];
...
if(!plusTooHigh){for(var _i80=0,_Dex$statNamesExceptH16=
Dex.statNamesExceptHP;_i80<_Dex$statNamesExceptH16.length;_i80++){var _stat2=_Dex$statNamesExceptH16[_i80];
...
}for(var _i82=0,_Dex$statNames4=
Dex.statNames;_i82<_Dex$statNames4.length;_i82++){var _stat3=_Dex$statNames4[_i82];
...
if(savedEVs<0)return null;for(var _i84=0,_Dex$statNames6=
Dex.statNames;_i84<_Dex$statNames6.length;_i84++){var _stat4=_Dex$statNames6[_i84];
