...
function BattleTextParser(){var perspective=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'p1';this.p1="Player 1";this.p2="Player 2";this.p3="Player 3";this.p4="Player 4";this.playerNames={};this.perspective=void 0;this.gen=9;this.turn=0;this.curLineSection='break';this.lowercaseRegExp=undefined;this.
...
var sideId=(/^(p\d+)/.exec(pokemon)||['',pokemon.slice(0,2)])[1];
...
var sideMatch=/^(p\d+)/.exec(side);
var sideId=sideMatch?sideMatch[1]:side.slice(0,2);
...
if(name){
var escaped=BattleTextParser.escapeReplace(name);
if(side==='p1')this.p1=escaped;else
if(side==='p2')this.p2=escaped;else
if(side==='p3')this.p3=escaped;else
if(side==='p4')this.p4=escaped;else
this.playerNames[side]=escaped;
}
return'';
}
